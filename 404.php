	...
	<main id="primary" class="site-main">
		...
		<section class="error-404 not-found">
			...
			<div class="four-container">
					...
					$fwd_fitness_archive_content = '<p>' . sprintf( esc_html__( 'Try looking in the monthly archives. %1$s', 'fwd-fitness' ), convert_smilies( ':)' ) ) . '</p>';
					the_widget( 'WP_Widget_Archives', 'dropdown=1', "after_title=</h2>$fwd_fitness_archive_content" );
